  ...
  return (
    <div className=" pt-52 pb-10 bg-white ">
      <div className=" flex flex-col items-center justify-center gap-10 max-w-[1300px] mx-auto">
        <h1 className="text-[54px] font-bold ">{page.pay_title}</h1>
        <div className="text-[22px] text-center items-center justify-center">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-3 bg-gradient-to-l from-liner to-white border rounded-[24px] shadow-xl shadow-grey py-5 px-80">
            <h1 className="font-bold text-[40px]">{page.enterprise_title}</h1>
            <p className="font-bold text-[18px] text-[#6F6C90]">{page.enterprise_text}</p>
            <button className=" border rounded-[10px] bg-black text-white px-[84px] py-[10px]">{page.enterprise_button}</button>
        </div>
      </div>
    </div>
  );
...
const Blog = ({ item, page }) => {
  ...
  return (
    <div
      className={clsx(
        " flex flex-col w-1/3 min-w-[400px] justify-start shadow-xl shadow-grey border rounded-[24px] gap-5 px-10 py-10",
        className
      )}
    >
