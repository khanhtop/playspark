export default function Hero({ page }) {
  return (
    <div className="lg:min-h-[900px] min-h-fit w-full bg-cover flex  bg-gradient-to-tr from-back to-white mt-20 lg:mt-0">
      <div className="max-w-[1600px] mx-auto flex-1 flex flex-col lg:flex-row text-black bg-cover px-40 pt-20 lg:gap-8 bg-black/0 items-center">
        ...
        <div className=" flex items-center justify-center mb-12 lg:mb-0 w-1/2 h-0 lg:h-auto">
          <img
