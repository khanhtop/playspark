export default function Hero({ page }) {
  return (
    <div className="lg:min-h-[612px] min-h-fit w-full bg-cover flex  bg-[#57F295] mt-20 lg:mt-0">
      <div className="max-full mx-auto flex-1 flex flex-col lg:flex-row text-black bg-cover px-[55px] pt-44 lg:gap-7 bg-black/0 items-center relative pb-10  max-w-[1200px] ">
        <div className="flex flex-col items-center  lg:items-start justify-start flex-1 text-start lg:text-left gap-10 lg:w-1/2 w-full ">
          ...
          <h1 className="text-[22px] font-bold leading-[30px]  max-w-[480px] lg:px-0 px-5">
            {page.hero_text_1}
          </h1>
