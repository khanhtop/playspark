...
export class CustomLoadingScreen implements ILoadingScreen {
  ...
  progressFiller: HTMLImageElement;
  constructor(public loadingUIText: string, loadingDive: HTMLDivElement) {
    this._loadingDiv = loadingDive;
  }
  public displayLoadingUI() {
    ...
    this.progressBar.style.left = "15%";
    this.progressBar.style.transform = "translateY(-50%)";
    ...
    this._loadingDiv.appendChild(this.progressBar);

    // Create the filler for the progress bar
    this.progressFiller = document.createElement("img");
    this.progressFiller.src =
    ...
    this.progressFiller.style.top = "50%";
    this.progressFiller.style.left = "15.5%";
    this.progressFiller.style.transform = "translateY(-50%)";
    this.progressFiller.style.width = "69%";
    this.progressFiller.style.height = "13px";

    //  progressFiller.style.height = "100%";
    //  progressFiller.style.backgroundColor = "#FEA250"; // Green for the progress
    this.progressFiller.style.width = "0%";
    this._loadingDiv.appendChild(this.progressFiller);
    ...
    let a = Events.preload.add((_data: any) => {
      ...
      this.progressFiller.style.width =
