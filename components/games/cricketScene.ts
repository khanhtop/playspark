...
export default class CricketScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio(
      'Crowd_Loop_v1_wav',
      '/pong/' + gameType + '/Crowd_Loop_v1_wav.wav'
    );
    this.load.audio(
      'Crowd_v1_Booing_wav',
    ...
    this.load.spritesheet(
      ...
      '/pong/' + gameType + '/pakistan_player_ready.png',
      { frameWidth: 234.83, frameHeight: 150 }
    );
    this.load.spritesheet(
  ...
  create() {
    ...
    const paki_ready_frame = this.anims.generateFrameNames(
      'pakistan_player_ready',
      { start: 0, end: 5 }
    );
    this.anims.create({
    ...
    this.auth_select_bg = this.add
      ...
      .setDisplaySize(w * 0.4, h * 0.6)
      .setOrigin(0.5, 0.5)
      .setDepth(1);

    this.auths_left = this.add
      .text(w / 2 - 120, h / 2 + 20, '<', this.country_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1)
    ...
    this.updateAuthorImage = (id) => {
      switch (id) {
        case 1:
          this.auths.setDisplaySize(250, 180).play('aus_ready_animation');
          console.log('austaaaaaaaaaaaaaaaaa');
          this.auth_country.setText('AUSTRALIA');
          break;
        case 2:
          this.auths.setDisplaySize(100, 100).play('paki_ready_animation');
    ...
    this.auth_country = this.add
      .text(w / 2, h / 2 - 100, 'AUSTRALIA', this.country_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1);

    this.auth_select_btn = this.add
      .sprite(w / 2, h / 2 + 135, 'green_btn')
      .setDisplaySize(155, 95)
      .setOrigin(0.5, 0.5)
      .setDepth(1);
    this.auths = this.physics.add
      .sprite(w / 2, h / 2 + 20, 'australia_player_ready')
      .setDisplaySize(144, 180)
    ...
    this.auth_select_group.add(
      this.add
      .text(w / 2, h / 2 + 135, 'SELECT', {...this.country_text_style, 
        fill: '#222',
        fontSize: '28px',
      })
      .setOrigin(0.5, 0.5)
    ...
    this.ballEffect = this.add.sprite(0, 0, 'ball').setAlpha(0).setDisplaySize(266 * 1.3, 200 * 1.3);
    ...
    this.game_state = this.add
      .text(w / 2, h / 2 - 130, 'GAME PAUSED', this.country_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1);
    this.player_country = this.add
      .text(w / 2 + 80, h / 2 - 50, 'AUSTRALIA', this.pause_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1);
    this.current_score = this.add
      .text(w / 2 + 80, h / 2, 'SCORE: 200', this.pause_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1);
    this.current_over = this.add
      .text(w / 2 + 80, h / 2 + 50, 'OVER: 3', this.pause_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1)
      .setDepth(1);
    this.resume_btn = this.add
      .sprite(w / 2 - 100, h / 2 + 135, 'green_btn')
      .setDisplaySize(155, 95)
      .setOrigin(0.5, 0.5)
      .setDepth(1)
      .setInteractive({ cursor: 'pointer' });
    this.quit_btn = this.add
      .sprite(w / 2 + 100, h / 2 + 135, 'red_btn')
      .setDisplaySize(155, 95)
      .setOrigin(0.5, 0.5)
      .setDepth(1)
      .setInteractive({ cursor: 'pointer' });
    ...
    this.pause_group.add(
      this.add
      .text(w / 2 - 100, h / 2 + 135, 'RESUME', {...this.country_text_style, 
        fill: '#222',
        fontSize: '28px',
      })
      .setOrigin(0.5, 0.5)
    ...
    this.pause_group.add(
      this.add
      .text(w / 2 + 100, h / 2 + 135, 'QUIT', {...this.country_text_style, 
        fill: '#222',
        fontSize: '28px',
      })
      .setOrigin(0.5, 0.5)
    ...
    this.stop_play.on('pointerup', () => {
      ...
      if (author_id == 1) {
        ...
        this.current_over.setText('OVER : ' + this.level);
      } else if (author_id == 2) {
        ...
        this.current_over.setText(
          'OVER: ' +
            (
              this.scorePanel.fire_count - this.scorePanel.score_count
            ).toString()
        );
      }
    });
    ...
    this.right_fall = this.physics.add
      ...
      .setOrigin(0.5, 0.5);
    this.wicket_line = this.physics.add
      .sprite(110, 505, 'fall')
      .setDisplaySize(0.1, 130)
      .setOrigin(0, 0)
      .setDepth(1);
    ...
    this.wickets_text = this.add
      .text(w * 0.26, h * 0.07, 'WICKETS', this.score_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1);
    this.runs_text = this.add
      .text(w * 0.46, h * 0.07, 'RUNS', this.runs_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1);
    this.overs_text = this.add
      .text(w * 0.665, h * 0.055, 'OVERS', this.score_text_style)
      .setOrigin(0.5, 0.5)
      .setAlpha(1);
    ...
    this.overlapScore6_1 = this.physics.add.overlap(
      ...
      () => {
        if (!isClicked && this.ball.type == 'old') {
          ...
          this.hitball_effect.setPosition(this.score6_1.x, this.score6_1.y);
          this.score6_1.setVisible(false);
          this.hitball_effect.setVisible(true).play('hitball_animation');
    ...
    this.overlapScore6_2 = this.physics.add.overlap(
      ...
      () => {
        if (!isClicked && this.ball.type == 'old') {
          ...
          this.Crowd_Cheers_v1_wav.play();
          this.hitball_effect.setPosition(this.score6_2.x, this.score6_2.y);
          this.score6_2.setVisible(false);
          this.hitball_effect.setVisible(true).play('hitball_animation');
    ...
    this.overlapScore6_3 = this.physics.add.overlap(
      ...
      () => {
        if (!isClicked && this.ball.type == 'old') {
          ...
          this.hitball_effect.setPosition(this.score6_3.x, this.score6_3.y);
          this.score6_3.setVisible(false);
          this.hitball_effect.setVisible(true).play('hitball_animation');
    ...
    this.overlapScore6_4 = this.physics.add.overlap(
      ...
      () => {
        if (!isClicked && this.ball.type == 'old') {
          ...
          this.hitball_effect.setPosition(this.score6_4.x, this.score6_4.y);
    ...
    this.overlapScore6_5 = this.physics.add.overlap(
      ...
      () => {
        if (!isClicked && this.ball.type == 'old') {
          ...
          this.hitball_effect.setPosition(this.score6_5.x, this.score6_5.y);
          this.score6_5.setVisible(false);
          this.hitball_effect.setVisible(true).play('hitball_animation');
