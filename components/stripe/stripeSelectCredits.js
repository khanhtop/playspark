...
function CreditRow({ amount, price, discount, first, onSelect }) {
  if (first) {
    return (
      <div className="flex items-center gap-2">
        <div className="border-b-2 w-16 text-center text-black/100 pb-2 mr-3 text-base">
          Amount
        </div>
  ...
  return (
    <div className="flex items-center gap-2">
      <div className="bg-green-200 w-16 text-center text-black/60 py-2 mr-3 text-lg rounded-lg">
        {amount}
      </div>
