...
export default function Marketing({ page }) {
  return (
    <div className=" bg-gradient-to-b from-[#50F8EE] to-white flex flex-col justify-center items-center py-10 gap-5">
      <h1 className="font-bold text-center lg:text-[54px] text-[48px] max-w-[420px] lg:max-w-[590px] mx-auto lg:-tracking-normal -tracking-wider  leading-[40px] lg:leading-[60px]  ">
      ...
      <button className="border rounded-[30px] text-[16px] px-[55px] py-[18px] mt-10 bg-[#2FE5A7]">
        See How It Works
      </button>
    </div>
  );
