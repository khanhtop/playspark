  ...
  return (
    <div className="w-full relative">
      <img
        ...
        className="w-full -z-10 absolute h-[700px]"
      />
      <div className="max-h-[700px] flex flex-row items-center justify-center py-[89px]">
        <div className="flex flex-col justify-center place-items-center gap-10 w-1/2">
          ...
          <p className="text-[22px] max-w-[629px] mx-auto text-center px-10">
            {page.your_game_text}
          </p>
          <button className=" rounded-[30px] px-[50px] py-[18px] text-[16px] bg-[#2FE5A7]">
            Play A Demo Game
          </button>
        </div>
